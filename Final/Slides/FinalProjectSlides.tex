...
\begin{block}{Load PCB $\rightarrow$ CPU}
\begin{lstlisting}[
language=MyC,
...
\begin{block}{CPU $\rightarrow$ PCB + queue update}
\begin{lstlisting}[language=MyC,
...
\begin{block}{CPU executes until burst time is exhausted}
\begin{lstlisting}[language=MyC,
  basicstyle=\fontsize{6.8pt}{7.2pt}\selectfont\ttfamily]
while (p->burstTime > 0 &&
...
\begin{block}{CPU $\rightarrow$ PCB + remove from ready queue}
\begin{lstlisting}[language=MyC,
  basicstyle=\fontsize{6.8pt}{7.2pt}\selectfont\ttfamily]
